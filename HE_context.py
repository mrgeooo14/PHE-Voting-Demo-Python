...
def generate_HE():
    ...
    print('Plaintext modulus: {}, Polynomial Coefficient Modulus: {}'.format(
        plaintext_mod, poly_coeff_mod))
    print()
...
def display_ciphers(candidates, results):  # Results as Pyfhel Ciphertext Objects
    for i in range(len(results)):
        ...
        print('Cipher for candidate {}: {} | Length: {}'.format(
            candidates[i], int_cipher, len(str(int_cipher))))


# Decryption is achieved by using the internal functions generated by the library (.decryptInt()).
